...
export async function POST(request: NextRequest) {
  try {
    ...
    let translatedText = await aiService.translate(v.text, sourceLanguage, v.targetLanguage);

    // Hashtag/Emoji যোগ করুন যদি চাওয়া হয়
    let hashtags = '';
    let emojis = '';
    if (v.includeHashtags || v.includeEmojis) {
      ...
      translatedText = enhanced.content;
