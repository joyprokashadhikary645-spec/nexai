...
export default function LoginPage() {
  ...
  const handleVerify2FA = async (e: React.FormEvent) => {
    e.preventDefault();
    if (!tempToken || twoFactorCode.length !== 6) return;
    setIsVerifying(true);
    try {
          ...
          {tempToken ? (
            <>
              ...
              <form onSubmit={handleVerify2FA} className="space-y-4">
                ...
                />
                <Button type="submit" isLoading={isVerifying} fullWidth size="lg" disabled={twoFactorCode.length !== 6}>
                  Verify
                </Button>
                <button
                  type="button"
                  onClick={() => { setTempToken(null); setTwoFactorCode(''); }}
